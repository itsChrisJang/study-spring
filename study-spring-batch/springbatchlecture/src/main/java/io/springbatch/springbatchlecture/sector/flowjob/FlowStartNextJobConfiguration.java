package io.springbatch.springbatchlecture.sector.flowjob;/*
...
@Configuration
public class FlowStartNextJobConfiguration {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;

    @Bean
    public Job flowStartNextJobBatchJob() {
        return jobBuilderFactory.get("flowStartNextJobBatchJob")
                .start(flowA())
                .next(step3())
                .next(flowB())
                .next(step6())
